# Reporte-3
## Descripción
```LCD 16x2 I2C``` hará visual los valores obtenidos de un ultrasonico el cual dará lecturas de una distacia haciendo la relación de ondas de sonido y a su vez por medio de la misma LCD se agregara datos generales del autor
